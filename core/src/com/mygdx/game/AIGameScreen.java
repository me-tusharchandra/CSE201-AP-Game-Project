...
public class AIGameScreen implements Screen {
    ...
    public AIGameScreen(TankStars game) {
        this.game = game;
    }
    ...
    public void show() {
        ...
        try {
            tank2 = new AITank(new Sprite(new Texture(Gdx.files.internal("Tanks/Coalition.png")), 0, 0, 167, 73), (TiledMapTileLayer) terrain.getLayers().get(0));
